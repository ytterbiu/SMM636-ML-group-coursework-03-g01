---
title:
  "Customer Segmentation in Wholesale Markets: PCA, Clustering, and Large
...
Throughout this appendix, we use a consistent visual format to distinguish
between prompts sent to the LLM, its responses, and our own commentary.

::: {.promptbox}

**Prompt** — shown with a right-hand border. These are the instructions and
